    ...
    public static function all(): array
    {
        ...
        $defs = [
            ...
            new ProviderDefinition(
                ...
                category: ProviderDefinition::CATEGORY_COMMUNICATION,
                credentialFields: [
                    ['name' => 'access_token', 'label' => 'Access Token', 'required' => true, 'config_key' => 'services.whatsapp.access_token', 'help' => 'System User token (Business Settings -> Users -> System Users). Never the 24-hour token from the API Setup page: OTP login dies when it expires.'],
                    ['name' => 'app_secret', 'label' => 'App Secret', 'config_key' => 'services.whatsapp.app_secret', 'help' => 'Meta app secret. Without it inbound webhooks are accepted unverified.'],
                    ['name' => 'webhook_verify_token', 'label' => 'Webhook Verify Token', 'config_key' => 'services.whatsapp.webhook_verify_token', 'help' => 'Any string you choose; paste the same value into Meta webhook setup.'],
                ],
                configFields: [
                    ['name' => 'phone_number_id', 'label' => 'Phone Number ID', 'required' => true, 'config_key' => 'services.whatsapp.phone_number_id', 'help' => 'Numeric id from WhatsApp Manager -> API Setup (not the phone number).'],
                    ['name' => 'api_version', 'label' => 'Graph API Version', 'config_key' => 'services.whatsapp.api_version', 'placeholder' => 'v21.0'],
                    ['name' => 'otp_template', 'label' => 'OTP Template Name', 'config_key' => 'services.whatsapp.otp_template', 'placeholder' => 'plantathome_otp', 'help' => 'An APPROVED Authentication-category template.'],
                    ['name' => 'otp_lang', 'label' => 'OTP Template Language', 'config_key' => 'services.whatsapp.otp_lang', 'placeholder' => 'en'],
                    ['name' => 'otp_has_button', 'label' => 'OTP Template Has Copy-Code Button', 'config_key' => 'services.whatsapp.otp_has_button', 'help' => 'Tick when the approved template carries the copy-code button Meta requires on authentication templates.'],
                    ['name' => 'notify_template', 'label' => 'Order-Update Template Name', 'config_key' => 'services.whatsapp.notify_template', 'placeholder' => 'plantathome_update', 'help' => 'An APPROVED Utility template whose body carries a single {{1}} placeholder for the message.'],
                    ['name' => 'notify_lang', 'label' => 'Order-Update Template Language', 'config_key' => 'services.whatsapp.notify_lang', 'placeholder' => 'en'],
                    ['name' => 'otp_ttl_minutes', 'label' => 'OTP Validity (minutes)', 'config_key' => 'services.whatsapp.otp_ttl_minutes', 'placeholder' => '5'],
                    ['name' => 'otp_max_attempts', 'label' => 'Max OTP Attempts', 'config_key' => 'services.whatsapp.otp_max_attempts', 'placeholder' => '5'],
                ],
                priority: 30,
            ),
            new ProviderDefinition(
            ...
            new ProviderDefinition(
                ...
                configFields: [
                    ...
                    ['name' => 'openai_model', 'label' => 'Model'],
                    ['name' => 'monthly_budget_inr', 'label' => 'Monthly Budget (₹)', 'type' => 'number'],
                    ['name' => 'plant_id_enabled', 'label' => 'Plant identification', 'type' => 'switch'],
                ],
                priority: 51,
            ...
            new ProviderDefinition(
                ...
                configFields: [
                    ...
                    ['name' => 'monthly_budget_inr', 'label' => 'Monthly Budget (₹)', 'type' => 'number'],
                    ['name' => 'auto_on_delivery', 'label' => 'Generate on delivery', 'type' => 'switch'],
                ],
                priority: 52,
