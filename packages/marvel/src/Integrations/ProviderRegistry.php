    ...
    public static function all(): array
    {
        ...
        $defs = [
            ...
            new ProviderDefinition(
                ...
                category: ProviderDefinition::CATEGORY_COMMUNICATION,
                credentialFields: [
                    ['name' => 'access_token', 'label' => 'Access Token', 'required' => true, 'config_key' => 'services.whatsapp.access_token', 'hint' => 'System User token (Business Settings -> Users -> System Users). Never the 24-hour token from the API Setup page: OTP login dies when it expires.'],
                    ['name' => 'app_secret', 'label' => 'App Secret', 'config_key' => 'services.whatsapp.app_secret', 'hint' => 'Meta app secret. Without it inbound webhooks are accepted unverified.'],
                    ['name' => 'webhook_verify_token', 'label' => 'Webhook Verify Token', 'config_key' => 'services.whatsapp.webhook_verify_token', 'hint' => 'Any string you choose; paste the same value into Meta webhook setup.'],
                ],
                configFields: [
                    ['name' => 'phone_number_id', 'label' => 'Phone Number ID', 'required' => true, 'config_key' => 'services.whatsapp.phone_number_id', 'hint' => 'Numeric id from WhatsApp Manager -> API Setup (not the phone number).'],
                    ['name' => 'api_version', 'label' => 'Graph API Version', 'config_key' => 'services.whatsapp.api_version', 'placeholder' => 'v21.0'],
                    ['name' => 'otp_template', 'label' => 'OTP Template Name', 'config_key' => 'services.whatsapp.otp_template', 'placeholder' => 'plantathome_otp', 'hint' => 'An APPROVED Authentication-category template.'],
                    ['name' => 'otp_lang', 'label' => 'OTP Template Language', 'config_key' => 'services.whatsapp.otp_lang', 'placeholder' => 'en'],
                    ['name' => 'otp_has_button', 'label' => 'OTP Template Has Copy-Code Button', 'config_key' => 'services.whatsapp.otp_has_button', 'hint' => 'Tick when the approved template carries the copy-code button Meta requires on authentication templates.'],
                    ['name' => 'notify_template', 'label' => 'Order-Update Template Name', 'config_key' => 'services.whatsapp.notify_template', 'placeholder' => 'plantathome_update', 'hint' => 'An APPROVED Utility template whose body carries a single {{1}} placeholder for the message.'],
