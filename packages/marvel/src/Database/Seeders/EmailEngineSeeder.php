...
class EmailEngineSeeder extends Seeder
{
    ...
    private function templates(): array
    {
        return [
            ...
            ['slug' => 'vendor-inventory-submitted', 'name' => 'Inventory submitted for review', 'category' => 'vendor',
             'subject' => 'Inventory submitted for review', 'preview' => 'We got your submission — an admin will review it',
             'heading' => 'Submitted for review',
             'body' => '<p>Your inventory for <strong>{{product_name}}</strong> was submitted for review. It stays hidden from customers until an admin approves it — you can watch its status on My stock &amp; prices.</p>',
             'cta' => ['label' => 'Open my inventory', 'url' => '{{login_url}}'],
             'vars' => ['vendor_name', 'product_name']],

            ['slug' => 'vendor-inventory-approved', 'name' => 'Inventory approved', 'category' => 'vendor',
             'subject' => 'Approved: {{product_name}} is live', 'preview' => 'Your inventory passed review',
             'heading' => 'Approved and live',
             'body' => '<p>Good news — your inventory for <strong>{{product_name}}</strong> was approved and is now offered to customers in your service cities.</p>',
             'cta' => ['label' => 'Open my inventory', 'url' => '{{login_url}}'],
             'vars' => ['vendor_name', 'product_name']],

            ['slug' => 'vendor-inventory-rejected', 'name' => 'Inventory rejected', 'category' => 'vendor',
             'subject' => 'Rejected: {{product_name}}', 'preview' => 'Your inventory did not pass review',
             'heading' => 'Not approved',
             'body' => '<p>Your inventory for <strong>{{product_name}}</strong> was not approved.</p><p><strong>Reason:</strong> {{reason}}</p><p>You can edit the listing and resubmit it for another review.</p>',
             'cta' => ['label' => 'Open my inventory', 'url' => '{{login_url}}'],
             'vars' => ['vendor_name', 'product_name', 'reason']],

            ['slug' => 'vendor-inventory-changes-requested', 'name' => 'Inventory changes requested', 'category' => 'vendor',
             'subject' => 'Changes requested: {{product_name}}', 'preview' => 'An admin asked for changes before approval',
             'heading' => 'Changes requested',
             'body' => '<p>An admin reviewed your inventory for <strong>{{product_name}}</strong> and asked for changes before it can go live.</p><p><strong>Requested:</strong> {{reason}}</p><p>Update the listing and save — that resubmits it automatically.</p>',
             'cta' => ['label' => 'Open my inventory', 'url' => '{{login_url}}'],
             'vars' => ['vendor_name', 'product_name', 'reason']],
